...
document.addEventListener(SAVED_EVENT, () => {
  ...
  elementCustomAlert.innerText = "Sukses Disimpan!";
...
document.addEventListener(MOVED_EVENT, () => {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert");
  elementCustomAlert.innerText = "Sukses Dipindahkan!";
...
document.addEventListener(DELETED_EVENT, () => {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert");
  elementCustomAlert.innerText = "Sukses Dihapus!";
...
const makeBookElement = (bookObject) => {
  ...
  if (bookObject.isComplete) {
    ...
    returnBtn.classList.add("move-btn");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const simpanForm = document.getElementById("formBookData");
